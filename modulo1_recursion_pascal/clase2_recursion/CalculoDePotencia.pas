...
begin
  if(n=0)then
    ...
    potencia1 := x * potencia1(x,n-1);   //achico el exponente hasta tener que el exponente es cero, el cual conosco su resultado, desp x se va multiplicando por si misma
end;
