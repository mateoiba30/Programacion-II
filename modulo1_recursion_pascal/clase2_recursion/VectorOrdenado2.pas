...
function pos(x:integer; v:vector; inicio,fin:dim):integer;
var
   medio:integer;
begin
  pos:=0;
...
begin
     ...
     readln(x);
     resultado:=pos(x,v,inicio,fin);

     if(resultado<>0)then begin
         writeln('Encontro el numero en la pos ',resultado);
         readkey();
     end
     else
