    ...
    public static void main (String[] args){
        ...
        for(i=0;i<dimf;i++){
            ...
            if(x==1){
                ...
                vectorS[i]= new GasNatural ( nro_de_gestion, fecha_solicitud, ingresos_mensuales, integrantes, region, persona, nro_medidor, m2_hogar, cant_estufas);
                ...
                vectorS[i]= new EnergiaElectrica ( nro_de_gestion, fecha_solicitud, ingresos_mensuales, integrantes, region, persona, nis, cant_electro);
            }
        ...
        for(i=0;i<dimf;i++){
            System.out.println(vectorS[i].tosstring());
        }
